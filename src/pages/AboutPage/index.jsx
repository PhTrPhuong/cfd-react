                ...
                <div className="banner__content">
                    <div className="container">
                        <h2 className="title --white">
                            <span>Sứ mệnh</span> của CFD Circle là kết nối,
                            truyền đạt kinh nghiệm thực tế và khởi dậy cảm hứng
                            từ những người tâm huyết để tạo ra sản phẩm chất
                            lượng cao.
                        </h2>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="aboutstory__content">
                        <h1 className="title --t2">
                            <span className="color--primary">Câu chuyện</span>{" "}
                            CFD Circle
                        </h1>
                        <p className="text">
                            Chúng tôi đã từng thắc mắc tại sao nhiều bạn đã học
                            ở các trường đại học nhưng khi đi làm cho các doanh
                            nghiệp thì phải đào tạo lại? Làm sao để giúp được
                            cho những bạn trái ngành có thể học và đi làm trong
                            thời gian ngắn nhất? Và làm thế nào để tạo ra nhiều
                            sản phẩm website có trải nghiệm người dùng tốt nhất?{" "}
                            <br />
                            <br />
                            Từ đó, CFD Circle ra đời để giải quyết tất cả những
                            vấn đề trên với mong muốn tạo ra nhiều sản phẩm
                            website chất lượng, tinh tế và có giá trị cao cho
            ...
            <section className="aboutbenifit --scpadding">
                <div className="container">
                    <h2 className="aboutbenifit__title title --t2">
                        ...
                        <br />
                        trên con đường tạo ra những giá trị cho cộng đồng và
                        chính mình.
                    </h2>
                    <div className="aboutbenifit__list">
                        <div className="item">
                            ...
                            <div className="content">
                                ...
                                <p className="text">
                                    Tất cả khoá học tại CFD Circle luôn được
                                    kiểm duyệt rất chặt chẽ, đảm bảo chất lượng
                                    với nhiều cấp độ khác nhau. Cùng phương châm
                                    luôn hướng tới một lộ trình học sát với thực
                                    tế, học viên có thể ứng dụng vào công việc
                                    ngày sau khoá học.
                                </p>
                            </div>
                        </div>
                        <div className="item">
                            ...
                            <div className="content">
                                ...
                                <p className="text">
                                    Với mong muốn đào tạo đội ngũ nhân lực chất
                                    lượng trong lĩnh vực Front-End Dev và UX/UI
                                    Design, học viên tại CFD Circle luôn được
                                    theo sát và hỗ trợ nhiệt tình để giúp tất cả
                                    mọi người hoàn thành khoá học thật tốt và
                        ...
                        <div className="item">
                            ...
                            <div className="content">
                                ...
                                <p className="text">
                                    Với nền tảng đào tạo trực tuyến CFD Circle,
                                    giảng viên không chỉ dạy offline, mà còn có
                                    thể tạo ra những lớp học trực tuyến cho
                                    riêng mình thông qua chương trình đối tác
                                    nội dung của CFD Circle.
                                </p>
                            </div>
                        </div>
                        <div className="item">
                            ...
                            <div className="content">
                                ...
                                <p className="text">
                                    Với nhu cầu rất lớn từ các doanh nghiệp
                                    trong và ngoài nước cùng những đối tác tuyển
                                    dụng của CFD Circle trong lĩnh vực Front-End
                                    Dev và UX/UI Design, học viên sẽ có cơ hội
                                    nhận được thông tin việc làm hấp dẫn, phù
                                    hợp với khả năng thông qua chương trình
                                    CFDers Talent. Ngoài ra, còn có thể trở
                                    thành mentor tại CFD Circle khi đáp ứng đủ
            ...
            <section className="aboutstudy --scpadding">
                <div className="container">
                    <h2 className="aboutstudy__title title --t2">
                        <span className="color--primary">Hình thức học</span> đa
                        dạng
                    </h2>
                    <div className="aboutstudy__item">
                        ...
                        <div className="aboutstudy__item-content">
                            <h4 className="title --t3">
                                Học offline tại văn phòng
                            </h4>
                            <div className="text">
                                Với trang thiết bị hiện đại, đội ngũ giảng viên
                                &amp; mentor sẽ sát cánh cùng bạn trong khoá học
                                offline tại học viện CFD Circle ở số 11b, Phan
                                Kế Bính, Đa Kao, Quận 1, TP Hồ Chí Minh.
                            </div>
                    ...
                    <div className="aboutstudy__item">
                        ...
                        <div className="aboutstudy__item-content">
                            <h4 className="title --t3">
                                Học online với lớp offline.
                            </h4>
                            <div className="text">
                                Nếu bạn muốn học trực tiếp với giảng viên nhưng
                                ở xa không thể đến lớp offline được thì có thể
                                học online thông qua Google Meet, gọi video chia
                                sẻ màn hình và được giảng viên, mentor hỗ trợ
                                như khi bạn học offline.
                            </div>
                            <a href="courses.html" className="btn btn--primary">
                                Khám phá
                            </a>
                    ...
                    <div className="aboutstudy__item">
                        ...
                        <div className="aboutstudy__item-content">
                            ...
                            <div className="text">
                                Nền tảng học online của CFD Circle có rất nhiều
                                khoá học video, bạn có thể học bất kỳ khi nào
                                mình muốn. Đặc biệt, bạn sẽ được hỗ trợ từ giảng
                                viên thông qua Google Meet hoặc đội ngũ mentor
                                của CFD Circle.
                            </div>
                            <a href="courses.html" className="btn btn--primary">
                                Khám phá
                    ...
                    <div className="aboutteachers__list">
                        <div className="itemteacher">
                            ...
                            <div className="itemteacher__info">
                                ...
                                <p className="itemteacher__info-des">
                                    Xin chào! Tôi là Trần Nghĩa - Creative
                                    Frontend Developer, người sáng lập CFD
                                    Circle và CFD Studio. Trong hơn 7 năm kinh
                                    nghiệm trong nghề, tôi luôn tạo ra những sản
                                    phẩm chất lượng cao, sáng tạo, tinh tế và
                                    phù hợp cho khách hàng trong và ngoài nước,
                                    cũng như mong muốn truyền đạt lại cho các
                                    bạn trẻ có đam mê và định hướng theo nghề
                                    Front-End Developer.
                                </p>
                            </div>
                        </div>
                        <div className="itemteacher">
                            ...
                            <div className="itemteacher__info">
                                ...
                                <p className="itemteacher__info-des">
                                    Xin chào mọi người! Tôi là Thiện, hiện đang
                                    là Front-End Developer tại CBI Chi Doanh.
                                    Mình đã bén duyên tham gia vào đại gia đình
                                    CFD Circle từ khóa CFD5. Trong quá trình học
                                    hỏi và chiến đấu cùng các anh em tại đây,
                                    mình đã rút ra rất nhiều kinh nghiệm thực
                                    tiễn và tìm được hướng đi phù hợp cho bản
                                    thân. CFD Circle với mình không chỉ là nơi
                                    trao đến bạn những kiến thức chuyên môn thực
                                    chiến, mà còn truyền một ngọn lửa mãnh liệt
                                    đến từng cá nhân để thúc đẩy sự phát triển
                        ...
                        <div className="itemteacher">
                            ...
                            <div className="itemteacher__info">
                                <div className="itemteacher__info-name">
                                    ...
                                    <span className="label badge --mentor">
                                        Mentor
                                    </span>
                                </div>
                                <h5 className="itemteacher__info-pos label">
                                ...
                                <p className="itemteacher__info-des">
                                    Xin chào! Tôi là Huy Nguyễn - Fullstack
                                    Developer, người đồng sáng lập CFD Circle
                                    &amp; CFD Studio. Với mong muốn truyền đạt
                                    những kinh nghiệm thực tế có được trong hơn
                                    5 năm đi làm cho các bạn trẻ có đam mê với
                                    lập trình front-end, cũng như back-end. Hi
                                    vọng tôi sẽ giúp cho các bạn có cái đầy đủ
                                    kiến thức và kỹ năng để ứng tuyển vào vị trí
                                    mà bạn hướng đến.
                                </p>
                            </div>
                        </div>
                        <div className="itemteacher">
                            ...
                            <div className="itemteacher__info">
                                ...
                                <p className="itemteacher__info-des">
                                    Chào bạn, nếu bạn đọc những dòng này hẳn là
                                    bạn rất quan tâm đến việc trở thành một
                                    developer, nhất là Front-end Developer. Vì
                                    vậy, mình là Huỳnh Anh Kiệt - hiện đang làm
                                    việc với vị trí Software Engineer - chapter
                                    Front-End tại Kyanon Digital và CFD Studio,
                                    đồng thời, là cựu học viên của CFD Circle sẽ
                                    đồng hành cùng bạn trong hành trình chinh
                                    phục mong ước đó. Sau thời gian dài học tập
                                    và làm việc, mình đã tích lũy được một số
                                    kinh nghiệm để có thể giúp đỡ những bạn có
                                    niềm đam mê với Front-end.
                                </p>
                            </div>
                        </div>
                        <div className="itemteacher">
                            ...
                            <div className="itemteacher__info">
                                ...
                                <p className="itemteacher__info-des">
                                    Xin chào! Tôi là Nguyễn An - Senior Frontend
                                    Developer tại T.O.P Group và CFD Studio. Rất
                                    mong có thể trao đổi và truyền đạt hết những
                                    kiến thức và kinh nghiệm từ những dự án thực
                                    tế mà tôi học được trong quá trình làm việc
                                    đến với học viên tại CFD Circle. Cùng học
                                    tập để hướng tới một Front-end Dev với những
                                    sản phẩm sáng tạo, tinh tế và chuyên nghiệp
            ...
            <section className="callregister">
                <div className="container">
                    <div className="callregister__content">
                        ...
                        <p>
                            Chúng tôi rất vui khi bạn quyết định trở thành một
                            phần của CFD Circle để cùng nhau học hỏi, lan toả và
                            chia sẻ những kinh nghiệm quý giá cho cộng đồng.
                        </p>
                        <a href="courses.html" className="btn btn--primary">
                            Tham gia Khoá học
                        </a>
