                ...
                <div className="blog__list">
                    ...
                    <div className="blog__list-item">
                        ...
                        <div className="content">
                            ...
                            <h2 className="title --t3">
                                <a href="blog-detail.html">
                                    Xây dựng portfolio cá nhân để thành công
                    ...
                    <div className="blog__list-item">
                        ...
                        <div className="content">
                            ...
                            <h2 className="title --t3">
                                <a href="blog-detail.html">
                                    ReactJS là gì? Tại sao ReactJs là thư viện
                                    Javascript phổ biến nhất hiện nay
                                </a>
                            </h2>
                            <div className="content__info">
                                <div className="user">
                    ...
                    <div className="blog__list-item">
                        ...
                        <div className="content">
                            ...
                            <h2 className="title --t3">
                                <a href="blog-detail.html">
                                    18 xu hướng web animation nổi bật trong năm
                                    2023
                                </a>
                            </h2>
                            <div className="content__info">
                    ...
                    <div className="blog__list-item">
                        ...
                        <div className="content">
                            ...
                            <h2 className="title --t3">
                                <a href="blog-detail.html">
                                    Zustand - State Management là gì? Liệu có
                                    thể so sánh được với Redux hay không?
                                </a>
                            </h2>
                            <div className="content__info">
                                <div className="user">
